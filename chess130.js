...
var character_peopleR = [],character_peopleL = [];
...
function preload(){
	...
	animationAdd(loadImage('animations/Blow3.png'),6,'useAnimations');
	animationAdd(loadImage('animations/Blow1.png'),6,'attackAnimations');
	animationAdd(0,0,'pathAnimations');
	animationAdd(loadImage('animations/ability0.png'),30,'abilityAnimations');

	character_peopleR.push(loadImage('data/people11.png'));
	character_peopleL.push(loadImage('data/people1.png'));
	animationAdd(loadImage('animations/Blow3.png'),6,'useAnimations');
	animationAdd(loadImage('animations/Sword2.png'),18,'attackAnimations');
	animationAdd(loadImage('animations/path1.png'),16,'pathAnimations');
	animationAdd(0,0,'abilityAnimations');

	character_peopleR.push(loadImage('data/people22.png'));
	character_peopleL.push(loadImage('data/people2.png'));
	animationAdd(loadImage('animations/Blow3.png'),6,'useAnimations');
	animationAdd(loadImage('animations/Blow1.png'),6,'attackAnimations');
	animationAdd(loadImage('animations/path2.png'),16,'pathAnimations');
	animationAdd(0,0,'abilityAnimations');

	character_peopleR.push(loadImage('data/people33.png'));
	character_peopleL.push(loadImage('data/people3.png'));
	animationAdd(loadImage('animations/Blow3.png'),6,'useAnimations');
	animationAdd(loadImage('animations/attack3.png'),31,'attackAnimations');
	animationAdd(loadImage('animations/path3.png'),25,'pathAnimations');
	animationAdd(loadImage('animations/ability3.png'),15,'abilityAnimations');
}

function animationAdd(data,frame,whichone){
	var picinfo = {
		pic :  data,
		frame : frame
	}
	if(whichone == 'useAnimations'){
		useAnimations.push(picinfo);
	}else if(whichone == 'attackAnimations'){
		attackAnimations.push(picinfo);
	}else if(whichone == 'pathAnimations'){
		pathAnimations.push(picinfo);
	}else if(whichone == 'abilityAnimations'){
		abilityAnimations.push(picinfo);
	}
}
// pics things--------------------
...
function ability(){
	var farmerAmountL=0,farmerAmountR=0,farmerWhoL = [],farmerWhoR = [],farmerWho = [];
